...
#ifndef __RETROMESSENGERCHATPAGE__
#define __RETROMESSENGERCHATPAGE__

/**
	@file
	Subclass of ChatPage, which is generated by wxFormBuilder.
*/

#include "RetroMessenger_GUI.h"

/** Implementing ChatPage */
class RetroMessengerChatPage : public ChatPage
{
protected:
	// Handlers for ChatPage events.
...
public:
	/** Constructor */
	//std::string rsid;
	RetroMessengerChatPage( wxWindow* parent );
};

#endif // __RETROMESSENGERCHATPAGE__
