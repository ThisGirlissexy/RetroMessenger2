...
#ifndef RETROMESSENGER_H
#define RETROMESSENGER_H
...
private:
	...
	std::vector< char* > wxCharPtrPtrToCharPtrPtr( wxChar** wxCharArray, int size, std::vector< std::vector< char > >& buffer );
