...
#ifndef RETROMESSENGERABOUT_H
#define RETROMESSENGERABOUT_H

#include "RetroMessenger_GUI.h"

class RetroMessengerAbout : public AboutDlg
{
public:
	RetroMessengerAbout( wxWindow* parent );
};

#endif // RETROMESSENGERABOUT_H
