...
#ifndef __RetroMessengerAddFriendDlg__
#define __RetroMessengerAddFriendDlg__

/**
@file
Subclass of AddFriendDlg, which is generated by wxFormBuilder.
*/

#include "RetroMessenger_GUI.h"

/** Implementing AddFriendDlg */
class RetroMessengerAddFriendDlg : public AddFriendDlg
{
protected:
	// Handlers for AddFriendDlg events.
...
public:
	/** Constructor */
	RetroMessengerAddFriendDlg( wxWindow* parent );
};

#endif // __RetroMessengerAddFriendDlg__
