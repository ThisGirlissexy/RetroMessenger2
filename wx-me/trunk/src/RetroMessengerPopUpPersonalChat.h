...
#ifndef __RetroMessengerPopUpPersonalChat__
#define __RetroMessengerPopUpPersonalChat__

/**
@file
Subclass of PopUpPersonalChat, which is generated by wxFormBuilder.
*/

#include "RetroMessenger_GUI.h"

/** Implementing PopUpPersonalChat */
class RetroMessengerPopUpPersonalChat : public PopUpPersonalChat
{
protected:
	// Handlers for PopUpPersonalChat events.
	void OnMessageUpdated( wxCommandEvent& event );
	void OnSendClicked( wxCommandEvent& event );
	
public:
	/** Constructor */
	RetroMessengerPopUpPersonalChat( wxWindow* parent );
};

#endif // __RetroMessengerPopUpPersonalChat__
