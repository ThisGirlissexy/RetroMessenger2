...
#include "RetroMessengerProgressDlg.h"

RetroMessengerProgressDlg::RetroMessengerProgressDlg( wxWindow* parent )
:
ProgressDlg( parent )
{
...
void RetroMessengerProgressDlg::OnCancel( wxCommandEvent& event )
{
