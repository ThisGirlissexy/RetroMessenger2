...
#ifndef __RetroMessengerCertificateDlg__
#define __RetroMessengerCertificateDlg__

/**
@file
Subclass of CertificateDlg, which is generated by wxFormBuilder.
*/

#include "RetroMessenger_GUI.h"
;
/** Implementing CertificateDlg */
class RetroMessengerCertificateDlg : public CertificateDlg
{
protected:
	// Handlers for CertificateDlg events.
	void OnHyperlinkHelpClicked( wxHyperlinkEvent& event );
	void OnComboBoxSelected( wxCommandEvent& event );
	void OnGenerateCertificateClicked( wxCommandEvent& event );
	
	
public:
	/** Constructor */
	RetroMessengerCertificateDlg( wxWindow* parent = NULL, int id=-1);
	~RetroMessengerCertificateDlg();
};

#endif // __RetroMessengerCertificateDlg__
