...
#ifndef __RetroMessengerProgressDlg__
#define __RetroMessengerProgressDlg__

/**
@file
Subclass of ProgressDlg, which is generated by wxFormBuilder.
*/

#include "RetroMessenger_GUI.h"

/** Implementing ProgressDlg */
class RetroMessengerProgressDlg : public ProgressDlg
{
protected:
	// Handlers for ProgressDlg events.
	void OnCancel( wxCommandEvent& event );
	
public:
	/** Constructor */
	RetroMessengerProgressDlg( wxWindow* parent );
};

#endif // __RetroMessengerProgressDlg__
