...
#ifndef __RetroMessengerMessageSentDlg__
#define __RetroMessengerMessageSentDlg__

/**
@file
Subclass of MessageSentDlg, which is generated by wxFormBuilder.
*/

#include "RetroMessenger_GUI.h"

/** Implementing MessageSentDlg */
class RetroMessengerMessageSentDlg : public MessageSentDlg
{
public:
	/** Constructor */
	RetroMessengerMessageSentDlg( wxWindow* parent );
};

#endif // __RetroMessengerMessageSentDlg__
