...
//Setters and getters for accessing RsInitConfig
//fields from RsInit class interface
void RsInit::SetBasedir(std::string basedir) { RsInitConfig::basedir = basedir;}
std::string RsInit::GetBasedir() {return RsInitConfig::basedir;}

void RsInit::SetDirSeparator(char sep) { RsInitConfig::dirSeperator = sep;}
char RsInit::GetDirSeparator() {return RsInitConfig::dirSeperator;}

void RsInit::SetAutoLogin(bool autoLogin) { RsInitConfig::autoLogin = autoLogin;}
bool RsInit::IsAutoLogin() {return RsInitConfig::autoLogin;}

void RsInit::SetLoadCert(std::string load_cert) { RsInitConfig::load_cert = load_cert;}
std::string RsInit::GetLoadCert() {return RsInitConfig::load_cert;}

void RsInit::SetLoadKey(std::string load_key) { RsInitConfig::load_key = load_key;}
std::string RsInit::GetLoadKey() {return RsInitConfig::load_key;}
