...
class RsInit
{
	public:
		...
		static void SetDirSeparator(char sep);
		static char GetDirSeparator();

		static void SetAutoLogin(bool autoLogin);
		static bool IsAutoLogin();

		static void SetLoadCert(std::string load_cert);
		static std::string GetLoadCert();

		static void SetLoadKey(std::string load_key);
		static std::string GetLoadKey();
